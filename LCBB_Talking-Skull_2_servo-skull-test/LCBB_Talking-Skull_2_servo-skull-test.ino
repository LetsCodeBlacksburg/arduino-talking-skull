 ...
 ******************************
  ...
  laughCount(n) function that will cycle the jaw n times. 
...
//****   -around 60-80 degrees of travel
//int mouthOpened=0 ;    // These values will have to be discovered for your servo configuration.
//int mouthClosed=72 ;   // These values will have to be discovered for your servo configuration.
